# darkweb_checker_handler.py

"""
AI‑first AWS Lambda handler for the DarkWeb-Checker agent.
...
from darkweb_checker import DarkWebCheckerAgent
...
CAPABILITY_ROUTER = {
    ...
    "DarkWebScan": "Dark-Web.Scan",
    "DataOriginsTrace": "Data-Origins.Trace",
    "DarkWebEvidenceCollect": "Dark-Web-Evidence.Collect"
}
