# agents/risk_assessor/runtime/risk_assessor_handler.py

"""
AI‑first AWS Lambda handler for the Risk-Assessor agent.
...
from agents.risk_assessor.runtime.risk_assessor import RiskAssessorAgent
...
_logger = get_platform_logger("risk-assessor-handler")


# ── Module-level singleton ─────────────────────────────────────────────────

_AGENT = RiskAssessorAgent(slim=True)
