# agents/workflow_builder/workflow_builder_handler.py
#
# Lambda handler for the Workflow-Builder agent.
#
...
_logger = get_platform_logger("workflow-builder-handler")
...
_CAPABILITY_DISPATCH = {
    "Workflow.Build": _AGENT.workflow_build,
}
