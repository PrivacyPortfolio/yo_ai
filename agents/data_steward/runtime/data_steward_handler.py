# /agents/data_steward/runtime/data_steward_handler.py
...
from agents.data_steward.runtime.data_steward import DataSteward
...
_logger = get_platform_logger("data-steward-handler")


# ── Module-level singleton ─────────────────────────────────────────────────

_AGENT = DataSteward(slim=True)
