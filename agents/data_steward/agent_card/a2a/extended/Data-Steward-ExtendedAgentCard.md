/**
 * This Data-Steward ExtendedCard conveys:
...
/**
* Data-Steward Extended Agent Card¶
*/

{
  ...
  "documentationUrl": "https://privacyportfolio.com/agent-directory/data-steward/auth/Data-Steward-ExtendedAgentCard.md",
  "supportedInterfaces": [
    {      "url": "https://privacyportfolio.com/agents/data_steward/a2a",
      "protocolBinding": "JSONRPC_HTTP",      "protocolVersion": "1.0"    },
    {      "url": "https://privacyportfolio.com/agents/data_steward/mesh",
      "protocolBinding": "RPC",      "protocolVersion": "1.0"    },
    {      "url": "https://privacyportfolio.com/agents/data_steward/api",
      "protocolBinding": "OPENAI_API",      "protocolVersion": "1.0"    },
    {      "url": "https://privacyportfolio.com/agents/data_steward/app",
      "protocolBinding": "MCP",      "protocolVersion": "1.0"    },
    {      "url": "https://privacyportfolio.com/agents/data_steward/op",
  ...
  "defaultOutputModes": ["application/json", "text/plain"],
    ...
    "x-artifacts": [
      ...
      },
      {
        ...
        "description": "Input schema for Phone.Call."
      },
      {
        ...
        "description": "Output schema for Phone.Call."
      },
      {
        "name": "Phone.Answer",
        "version": "1.0.0",
      ...
      },
      {
        ...
        "description": "Input schema for Phone.Answer."
      },
      {
        ...
        "description": "Output schema for Phone.Answer."
      },
      {
        "name": "Data-Request.Govern",
        "version": "1.0.0",
      ...
      },
      {
        ...
        "description": "Input schema for Data-Request.Govern."
      },
      {
        ...
        "description": "Output schema for Data-Request.Govern."
      },
      {
        "name": "Email.Read",
        "version": "1.0.0",
      ...
      },
      {
        ...
        "description": "Input schema for Email.Read."
      },
      {
        ...
        "description": "Output schema for Email.Read."
      },
      {
        "name": "Email.Send",
        "version": "1.0.0",
      ...
      },
      {
        ...
        "description": "Input schema for Email.Send."
      },
      {
        ...
        "description": "Output schema for Email.Send."
      }
  ]
}