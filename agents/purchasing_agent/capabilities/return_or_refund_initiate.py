...
async def run(payload: dict, ctx: YoAiContext) -> dict:
    ...
    Stub — acknowledges initiation. Next: integrate with vendor return portal
    ...
    return {
        "capability": "Return-Or-Refund.Initiate",
        "status": "stub",
        "message": "Stub return/refund initiated." if not ctx.get("dry_run") else "Stub dry_run — no action taken.",
        "item": item,
        "reason": reason,
        "orderId": order_id,
        "initiated": not ctx.get("dry_run"),
