# ip_inspector_handler.py

"""
AI‑first AWS Lambda handler for the IP-Inspector agent.
...
from ip_inspector import IPInspectorAgent
...
_logger = get_logger("ip-inspector-handler")


# ── Module-level singleton ─────────────────────────────────────────────────

_AGENT = IPInspectorAgent(slim=True)

# ── Capability routing ─────────────────────────────────────────────────────

_CAPABILITY_ROUTER = {
"IPAssetsDiscover": "IP-Assets.Discover",
"IPToProductsMap": "IP-to-Products.Map",
"ImplementationInstancesSearch": "Implementation-Instances.Search",
"UseCasesInfer": "Use-Cases.Infer",
"IPPortfolioCluster": "IP-Portfolio.Cluster",
"IPReportGenerate": "IP-Report.Generate",
"IPRiskEvaluate": "IP-Risk.Evaluate",
"IPProvenanceTrace": "IP-Provenance.Trace",
"RelatedIPDiscover": "Related-IP.Discover"
}
