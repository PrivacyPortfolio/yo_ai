# /agents/tech_inspector/runtime/tech_inspector_handler.py

"""
AI‑first AWS Lambda handler for the Talent-Agent agent.
...
from tech_inspector import TechInspectorAgent
...
_logger = get_logger("tech-inspector-handler")


# ── Module-level singleton ─────────────────────────────────────────────────

_AGENT = TechInspectorAgent(slim=True)

# ── Capability routing ─────────────────────────────────────────────────────

_CAPABILITY_ROUTER = {
"ThirdPartyAssetsDiscover": "Third-Party-Assets.Discover",
"AssetIntegrationsMap": "Asset-Integrations.Map",
"ImplementationDetailsAnalyze": "Implementation-Details.Analyze",
"UsageInstancesSearch": "Usage-Instances.Search",
"TechnicalImpactInfer": "Technical-Impact.Infer",
"AssetPortfolioCluster": "Asset-Portfolio.Cluster",
"IntegrationRiskEvaluate": "Integration-Risk.Evaluate",
"IntegrationProvenanceTrace": "Integration-Provenance.Trace",
"RelatedAssetsDetect": "Related-Assets.Detect",
"TechReportGenerate": "Tech-Report.Generate"
}
