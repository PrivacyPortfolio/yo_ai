# agents/profile_builder/runtime/profile_builder_handler.py

"""
AI‑first AWS Lambda handler for the Profile-Builder agent.
...
from agents.profile_builder.runtime.profile_builder import ProfileBuilderAgent
...
_logger = get_platform_logger("profile-builder-handler")


# ── Module-level singleton ─────────────────────────────────────────────────

_AGENT = ProfileBuilderAgent(slim=True)

# ── Capability routing ─────────────────────────────────────────────────────

_CAPABILITY_ROUTER = {
"orgProfileBuild": "Org-Profile.Build"
}
