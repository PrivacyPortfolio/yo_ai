...
# The inner try/except catches everything; the LOG.write in the except block
# is best-effort. If it also fails, stdlib logging is the last resort.
#
...
_CAPABILITY_DISPATCH = {
    "Handle.Exception": _AGENT.handle_exception,
}
