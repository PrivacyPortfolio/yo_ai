# agents/socialmedia_checker/runtime/socialmedia_checker_handler.py

"""
AI‑first AWS Lambda handler for the SocialMedia-Checker agent.
...
from socialmedia_checker import SocialMediaCheckerAgent
...
_logger = get_logger("socialmedia-checker-handler")


# ── Module-level singleton ─────────────────────────────────────────────────

_AGENT = SocialMediaCheckerAgent(slim=True)

# ── Capability routing ─────────────────────────────────────────────────────

_CAPABILITY_ROUTER = {
"PromotionalEngagementVerify": "Promotional-Engagement.Verify",
